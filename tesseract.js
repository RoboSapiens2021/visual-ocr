            ...
            (o =
               ...
               typeof (n = function () {
                  return function () {
                     ...
                     for (
                        var n, o = document.createElement("a"), i = 1;
                        i < e;
                        i++
                     )
      ...
      function (e, t, r) {
         ...
         e.exports = function () {
            ...
            var P = function (e, t) {
               ...
               E = function (e) {
                  ...
                  return new Promise(function (e, i) {
                     p(
                        ...
                        P(n, e),
                        S(n, i),
                        O(k, { workerId: t, jobId: r, action: n, payload: o });
                  });
               },
               L = function (e) {
                  return E(
                     l({ id: e, action: "load", payload: { options: c } })
                  );
               },
               T = function (e, t, r) {
                  return E(
               ...
               A = function (e, t, r) {
                  return E(
                     l({ id: r, action: "FS", payload: { method: e, args: t } })
                  );
               },
               D = function () {
                  var e =
               ...
               m(k, function (e) {
                  ...
                  if ("resolve" === o) {
                     ...
                     "recognize" === c
                        ...
                        : "getPDF" === c &&
                          (s = Array.from(
                             a({}, u, { length: Object.keys(u).length })
                          )),
                        y[c]({ jobId: r, data: s });
                  } else if ("reject" === o) {
                     if ((x[c](u), !i)) throw Error(u);
                     i(u);
                  } else "progress" === o && n(u);
               }),
               {
               ...
               d = function (t, s) {
                  return new Promise(function (f, l) {
                     ...
                     i.push(
                        ...
                        u(
                           "[".concat(e, "]: Add ").concat(d.id, " to JobQueue")
                        ),
                        u(
                           "[".concat(e, "]: JobQueue length=").concat(i.length)
                        ),
                        p();
                  });
               };
                  ...
                  c.paragraphs.forEach(function (t) {
                     t.lines.forEach(function (r) {
                        r.words.forEach(function (o) {
                           ...
                           o.push(
                              n({}, r, { page: e, block: c, paragraph: t })
                           );
                     }),
                        ...
                        for (;;)
                           switch ((e.prev = e.next)) {
                              ...
                              case 3:
                                 ...
                                 break;
                              case 8:
                                 return (e.next = 10), fetch(i(t));
                              case 10:
                                 return (
                                    (n = e.sent), (e.next = 13), n.arrayBuffer()
                                 );
                              case 13:
                                 r = e.sent;
                              case 14:
